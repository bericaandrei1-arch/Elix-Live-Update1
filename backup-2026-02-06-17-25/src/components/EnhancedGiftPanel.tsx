...
export function EnhancedGiftPanel({ onSelectGift, userCoins, onRechargeSuccess }: GiftPanelProps) {
  ...
  return (
    <div ref={panelRef} className="bg-[#1a1a1a]/95 rounded-t-3xl p-2 pb-3 h-full overflow-y-auto no-scrollbar border-t-2 border-l-2 border-r-2 border-transparent shadow-2xl w-full" style={{ borderImage: 'linear-gradient(to right, #8B0000, #00008B) 1' }}>
