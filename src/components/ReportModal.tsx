        ...
        <div className="flex-1 overflow-y-auto p-3 scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
          ...
          <div className="mb-3">
            ...
            <textarea
              ...
              className="w-full bg-black border border-white/10 text-white rounded-md p-2 text-[10px] focus:outline-none focus:border-white/20 resize-none leading-tight"
              rows={2}
              maxLength={500}
            />
